Public Class Colori
    ...
    Public Function ConHEXDEC(hex As String) As String
        Dim stringa As String = hex
        Dim dec As Integer = 0
        If stringa(0) = "F" Then
            dec += 1 * 15
        ElseIf stringa(0) = "E" Then
            dec += 1 * 14
        ElseIf stringa(0) = "D" Then
            dec += 1 * 13
        ElseIf stringa(0) = "C" Then
            dec += 1 * 12
        ElseIf stringa(0) = "B" Then
            dec += 1 * 11
        ElseIf stringa(0) = "A" Then
            dec += 1 * 10
        ElseIf stringa(0) = "9" Then
            dec += 1 * 9
        ElseIf stringa(0) = "8" Then
            dec += 1 * 8
        ElseIf stringa(0) = "7" Then
            dec += 1 * 7
        ElseIf stringa(0) = "6" Then
            dec += 1 * 6
        ElseIf stringa(0) = "5" Then
            dec += 1 * 5
        ElseIf stringa(0) = "4" Then
            dec += 1 * 4
        ElseIf stringa(0) = "3" Then
            dec += 1 * 3
        ElseIf stringa(0) = "2" Then
            dec += 1 * 2
        ElseIf stringa(0) = "1" Then
            dec += 1 * 1
        ElseIf stringa(0) = "0" Then
            dec += 1 * 0
        End If
        If stringa(1) = "F" Then
            dec += 16 * 15
        ElseIf stringa(1) = "E" Then
            dec += 16 * 14
        ElseIf stringa(1) = "D" Then
            dec += 16 * 13
        ElseIf stringa(1) = "C" Then
            dec += 16 * 12
        ElseIf stringa(1) = "B" Then
            dec += 16 * 11
        ElseIf stringa(1) = "A" Then
            dec += 16 * 10
        ElseIf stringa(1) = "9" Then
            dec += 16 * 9
        ElseIf stringa(1) = "8" Then
            dec += 16 * 8
        ElseIf stringa(1) = "7" Then
            dec += 16 * 7
        ElseIf stringa(1) = "6" Then
            dec += 16 * 6
        ElseIf stringa(1) = "5" Then
            dec += 16 * 5
        ElseIf stringa(1) = "4" Then
            dec += 16 * 4
        ElseIf stringa(1) = "3" Then
            dec += 16 * 3
        ElseIf stringa(1) = "2" Then
            dec += 16 * 2
        ElseIf stringa(1) = "1" Then
            dec += 16 * 1
        ElseIf stringa(1) = "0" Then
            dec += 16 * 0
        End If
        Return String.Join(" ", dec)
    End Function

    Public Function InvertiHEX(frase As String) As String
        Try
            'Dim parole As String() = frase.Split(" "c)

            'For p As Integer = 0 To parole.Length - 1
            '    Dim ca As Char() = parole(p).ToCharArray
            '    ca = ca.Reverse.ToArray
            '    Dim sb As New System.Text.StringBuilder
            '    For Each c As Char In ca
            '        sb.Append(c)
            '    Next
            '    parole(p) = sb.ToString
            'Next
            Dim parole As String = frase
            Dim parola1 As String = ""
            Dim parola2 As String = ""
            Dim parola3 As String = ""
            Dim newstringa As String = ""
            For p As Integer = 0 To 5
                Dim c As Char = parole(p)
                If (p = "0" Or p = "1") Then
                    parola1 &= c
                ...
                End If
            Next
            newstringa = parola3 & parola2 & parola1

            RossoTextBox.Text = ConHEXDEC(parola1.Reverse.ToArray)
            VerdeTextBox.Text = ConHEXDEC(parola2.Reverse.ToArray)
            BluTextBox.Text = ConHEXDEC(parola3.Reverse.ToArray)

            'Dim stringa As String = frase
            'Dim newStringa As String = ""
            'Dim NewSTR As String = ""
            'If stringa IsNot Nothing Then
            '    For i As Integer = stringa.Length To 1 Step -1
            '        newStringa &= stringa.Substring(i - 1, 1)
            '    Next
            'End If

            Return String.Join(" ", newstringa)
    ...
    Private Sub PictureBox17_Click(sender As Object, e As EventArgs) Handles PictureBox17.Click
        ...
        HEXTextBox.Text = CodiceHEX.Text.Replace("#", "")
        TextBox1.Text = InvertiHEX(HEXTextBox.Text)
    End Sub

    Private Sub Colori_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If HEXTextBox.Text = "" Then
    ...
    Private Sub RossoTextBox_LostFocus(sender As Object, e As EventArgs) Handles RossoTextBox.LostFocus
        Try
            If RossoTextBox.Text = "" Then RossoTextBox.Text = "0"
            genera_hex()
        Catch ex As Exception
            MsgBox("Si è verificato un errore non gestito. Per favore, riprova ad inserire i valori." & vbNewLine & "N.B. Possono essere inseriti solo caratteri da 0 a 9 (numeri decimali).", MsgBoxStyle.Exclamation, "Errore non gestito")
            Me.Close()
        End Try
    End Sub
    ...
    Private Sub VerdeTextBox_LostFocus(sender As Object, e As EventArgs) Handles VerdeTextBox.LostFocus
        Try
            If VerdeTextBox.Text = "" Then VerdeTextBox.Text = "0"
            genera_hex()
        Catch ex As Exception
            MsgBox("Si è verificato un errore non gestito. Per favore, riprova ad inserire i valori." & vbNewLine & "N.B. Possono essere inseriti solo caratteri da 0 a 9 (numeri decimali).", MsgBoxStyle.Exclamation, "Errore non gestito")
            Me.Close()
    ...
    Private Sub BluTextBox_LostFocus(sender As Object, e As EventArgs) Handles BluTextBox.LostFocus
        Try
            If BluTextBox.Text = "" Then BluTextBox.Text = "0"
            genera_hex()
        Catch ex As Exception
            MsgBox("Si è verificato un errore non gestito. Per favore, riprova ad inserire i valori." & vbNewLine & "N.B. Possono essere inseriti solo caratteri da 0 a 9 (numeri decimali).", MsgBoxStyle.Exclamation, "Errore non gestito")
            Me.Close()
    ...
    Function genera_hex()
        ...
        CodiceRGB.Text = ("#" & TextBox2.Text & TextBox3.Text & TextBox4.Text)
        HEXTextBox.Text = (CodiceRGB.Text.Replace("#", ""))
        TextBox1.Text = InvertiHEX(HEXTextBox.Text)
        AnteprimaColore.BackColor = System.Drawing.ColorTranslator.FromOle("&h" & TextBox1.Text)
        CodiceHEX.Text = HEXTextBox.Text
    End Function
    ...
    Private Sub HEXTextBox_LostFocus(sender As Object, e As EventArgs) Handles HEXTextBox.LostFocus
        ...
        For i As Integer = HEXTextBox.TextLength To 5
            HEXTextBox.Text = HEXTextBox.Text & "0"
        Next i
    ...
    Private Sub IncollaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles IncollaToolStripMenuItem.Click
        ...
        TextBox5.Clear()
        TextBox5.Paste()
        HEXTextBox.Text = TextBox5.Text.Replace("#", "")
    End Sub
    ...
    Private Sub ToolStripMenuItem6_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem6.Click
        RossoTextBox.SelectAll()
        RossoTextBox.Copy()
    End Sub

    Private Sub ToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem2.Click
        VerdeTextBox.SelectAll()
        VerdeTextBox.Copy()
    End Sub

    Private Sub ToolStripMenuItem4_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem4.Click
        BluTextBox.SelectAll()
        BluTextBox.Copy()
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        If RossoTextBox.Text < 255 Then RossoTextBox.Text += 1
        genera_hex()
    End Sub

    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        If RossoTextBox.Text > 0 Then RossoTextBox.Text -= 1
        genera_hex()
    End Sub

    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If VerdeTextBox.Text < 255 Then VerdeTextBox.Text += 1
        genera_hex()
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If VerdeTextBox.Text > 0 Then VerdeTextBox.Text -= 1
        genera_hex()
    End Sub

    Private Sub Button65_Click(sender As Object, e As EventArgs) Handles Button65.Click
        If BluTextBox.Text < 255 Then BluTextBox.Text += 1
        genera_hex()
    End Sub

    Private Sub Button64_Click(sender As Object, e As EventArgs) Handles Button64.Click
        If BluTextBox.Text > 0 Then BluTextBox.Text -= 1
        genera_hex()
    End Sub

    Private Sub VerdeTextBox_TextChanged(sender As Object, e As EventArgs) Handles VerdeTextBox.TextChanged

    End Sub

    Private Sub BluTextBox_TextChanged(sender As Object, e As EventArgs) Handles BluTextBox.TextChanged
