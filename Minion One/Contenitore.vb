Public Class Contenitore
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        If Panel10.BackColor = Color.Transparent Then
            ...
            If TextBox24.Text = ("si") Then
                If MyCEF.CSSSIoNOtb.Text = ("no") Then
                    ...
                    If MyCEF.SelezionatoSalvatoDagliAppunti.Text <> "" Then
                        BottoneCodice.Text = BottoneCodice.Text.Replace("@@contenuto div@@", MyCEF.SelezionatoSalvatoDagliAppunti.Text)
                    Else
                        BottoneCodice.Text = BottoneCodice.Text.Replace("@@contenuto div@@", "")
                    End If
                ...
                Else
                    ...
                    If MyCEF.SelezionatoSalvatoDagliAppunti.Text <> "" Then
                        BottoneCodiceHTML.Text = BottoneCodiceHTML.Text.Replace("@@contenuto div@@", MyCEF.SelezionatoSalvatoDagliAppunti.Text)
                    Else
                        BottoneCodice.Text = BottoneCodice.Text.Replace("@@contenuto div@@", "")
                    End If
                    MyCEF.SelezionatoSalvatoDagliAppunti.SelectAll()
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs) Handles Button15.Click
        If TextBox14.Text = "" Then
            TextBox14.Text = ("1")
        End If
        If TextBox14.Text = "" Or TextBox14.Text.Replace(" ", "") = "" Or TextBox14.Text = "0" Then
        Else
            TextBox14.Text -= 1
        End If
    End Sub
