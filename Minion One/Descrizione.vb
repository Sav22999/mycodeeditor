Public Class Descrizione
    ...
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        ...
        End If
        If DescrizioneColoreTesto.Text = "" Then
            Button43.BackColor = Color.Red
        End If
        If DescrizioneTestoCarattere.Text = "" Then
        ...
        If TextBox1.Text = "" Or TextBox9.Text = "" Or TextBox9.Text = "" Or TextBox13.Text = "" Or TextBox11.Text = "" Or TextBox12.Text = "" Or TextBox10.Text = "" Or TextBox15.Text = "" Or ComboBox5.Text = "" Then
            TextBox24.Text = "no"
        Else
            TextBox24.Text = "si"
        End If
        ...
        Else
            If TextBox24.Text = ("si") Then
                If MyCEF.CSSSIoNOtb.Text = ("no") Then
                    ...
                    BottoneCodice.Text = BottoneCodice.Text.Replace("@@colore testo@@", DescrizioneColoreTesto.Text)
                    BottoneCodice.Text = BottoneCodice.Text.Replace("@@font-family@@", DescrizioneTestoCarattere.Text)
                ...
                Else
                    ...
                    BottoneCodiceCSS.Text = BottoneCodiceCSS.Text.Replace("@@colore testo@@", DescrizioneColoreTesto.Text)
                    BottoneCodiceCSS.Text = BottoneCodiceCSS.Text.Replace("@@font-family@@", DescrizioneTestoCarattere.Text)
    ...
    Private Sub PictureBox15_Click(sender As Object, e As EventArgs) Handles PictureBox15.Click
        ...
        DescrizioneColoreTesto.Text = ("#000000")
    ...
    Private Sub PictureBox13_Click(sender As Object, e As EventArgs) Handles PictureBox13.Click
        ...
        DescrizioneColoreTesto.Text = ("#0000FF")
        Panel27.Visible = False
        Button43.BackColor = Panel1.BackColor
    End Sub
    ...
    Private Sub PictureBox12_Click(sender As Object, e As EventArgs) Handles PictureBox12.Click
        ...
        DescrizioneColoreTesto.Text = ("#FF00FF")
        Panel27.Visible = False
        Button43.BackColor = Panel1.BackColor
    End Sub
    ...
    Private Sub PictureBox14_Click(sender As Object, e As EventArgs) Handles PictureBox14.Click
        ...
        DescrizioneColoreTesto.Text = ("#FF0000")
        Panel27.Visible = False
        Button43.BackColor = Panel1.BackColor
    End Sub
    ...
    Private Sub PictureBox19_Click(sender As Object, e As EventArgs) Handles PictureBox19.Click
        ...
        DescrizioneColoreTesto.Text = ("#00FF00")
        Panel27.Visible = False
        Button43.BackColor = Panel1.BackColor
    End Sub
    ...
    Private Sub PictureBox18_Click(sender As Object, e As EventArgs) Handles PictureBox18.Click
        ...
        DescrizioneColoreTesto.Text = ("#FFFF00")
        Panel27.Visible = False
        Button43.BackColor = Panel1.BackColor
    End Sub
    ...
    Private Sub PictureBox17_Click(sender As Object, e As EventArgs) Handles PictureBox17.Click
        ...
        DescrizioneColoreTesto.Text = ("#00FFFF")
        Panel27.Visible = False
        Button43.BackColor = Panel1.BackColor
    End Sub
    ...
    Private Sub PictureBox16_Click(sender As Object, e As EventArgs) Handles PictureBox16.Click
        ...
        DescrizioneColoreTesto.Text = ("#FFFFFF")
        Panel27.Visible = False
        Button43.BackColor = Panel1.BackColor
    End Sub
    ...
    Private Sub Button55_Click(sender As Object, e As EventArgs) Handles Button55.Click
        Colori.Dove.Text = ("TestoColoreDescrizione")


        Colori.HEXTextBox.Text = DescrizioneColoreTesto.Text.Replace("#", "")
    ...
    Private Sub Button47_Click(sender As Object, e As EventArgs) Handles Button47.Click
        Carattere.Dove.Text = ("DescrizioneTesto")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Process.Start("http://minionone.altervista.org/Wiki/TutteLeFunzioni/Descrizione/")
    End Sub
