Public Class NuovoProgetto
    ...
    Private Sub AnteprimaButtonR_Click(sender As Object, e As EventArgs) Handles AnteprimaButtonR.Click
        ...
        If ((TextBox9.Text = MyCEF.TraduzioneLinguaTxt.Lines(502) And TextBox9.ForeColor = Color.DarkGray) Or TextBox9.Text.Replace(" ", "") = "") Then
            'TextBox9.BackColor = Color.Red
            Timer1.Start()
        ElseIf ((TextBox1.Text = MyCEF.TraduzioneLinguaTxt.Lines(776) And TextBox1.ForeColor = Color.DarkGray) Or TextBox1.Text.Replace(" ", "") = "") Then
            Timer2.Start()
        End If
        If Not (((TextBox9.Text = MyCEF.TraduzioneLinguaTxt.Lines(502) And TextBox9.ForeColor = Color.DarkGray) Or TextBox9.Text.Replace(" ", "") = "") Or ((TextBox1.Text = MyCEF.TraduzioneLinguaTxt.Lines(776) And TextBox1.ForeColor = Color.DarkGray) Or TextBox1.Text.Replace(" ", "") = "")) Then
            If My.Computer.FileSystem.DirectoryExists(TextBox1.Text) Then
                If Not System.IO.File.Exists(TextBox1.Text & TextBox9.Text & ".html") Then
                    ...
                    MyCEF.FastColoredTextBox1.Clear()
    ...
    Private Sub TextBox9_GotFocus(sender As Object, e As EventArgs) Handles TextBox9.GotFocus
        If (TextBox9.Text = MyCEF.TraduzioneLinguaTxt.Lines(502) And TextBox9.ForeColor = Color.DarkGray) Then
    ...
    Private Sub TextBox9_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox9.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            '        If Dir(TextBox1.Text & TextBox9.Text & ".html") = "" Then
    ...
    Private Sub TextBox9_LostFocus(sender As Object, e As EventArgs) Handles TextBox9.LostFocus
        If TextBox9.Text = ("") Or TextBox9.Text.Replace(" ", "") = "" Then
            ...
            TextBox9.Text = MyCEF.TraduzioneLinguaTxt.Lines(502)
        End If
    End Sub
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf timertxt.Text = ("3") Then
            TextBox9.BackColor = Color.WhiteSmoke
            timertxt.Text = ("0")
            If ((TextBox1.Text = MyCEF.TraduzioneLinguaTxt.Lines(776) And TextBox1.ForeColor = Color.DarkGray) Or TextBox1.Text.Replace(" ", "") = "") Then
                Timer2.Start()
            End If
            Timer1.Stop()
        End If
    ...
    Private Sub TextBox1_LostFocus(sender As Object, e As EventArgs) Handles TextBox1.LostFocus
        If TextBox1.Text = ("") Or TextBox1.Text.Replace(" ", "") = "" Then
            ...
            TextBox1.Text = MyCEF.TraduzioneLinguaTxt.Lines(776)
        End If
    End Sub

    Private Sub TextBox1_GotFocus(sender As Object, e As EventArgs) Handles TextBox1.GotFocus
        If (TextBox1.Text = MyCEF.TraduzioneLinguaTxt.Lines(776) And TextBox1.ForeColor = Color.DarkGray) Then
            TextBox1.ForeColor = Color.DarkRed
            TextBox1.Text = ("")
        End If
    End Sub
