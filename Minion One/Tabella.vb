Public Class Tabella
    ...
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        ...
        Riga = 1
        Colonna = 1
        Do While Riga <= TextBox1.Text
            Colonna = 1
            TextBox2.Text = TextBox2.Text & ("<tr>") & vbNewLine
            Do While Colonna <= TextBox8.Text
                TextBox2.Text = TextBox2.Text & vbTab & ("<td id=" & Chr(34) & TextBox9.Text & Chr(34) & ">") & "<!---" & Colonna & "° colonna - " & Riga & "° riga--->" & vbNewLine & vbTab & "&nbsp;" & vbNewLine & vbTab & ("</td>") & vbNewLine
        ...
        Else
            If TextBox24.Text = ("si") Then
                If MyCEF.CSSSIoNOtb.Text = ("no") Then
                    ...
                    If Not TextBox16.Enabled Then cb1 = ""
                    TabellaCodice.Text = TabellaCodice.Text.Replace("@@altezza tabella@@", TextBox16.Text + cb1)
                    Dim cb2 As String = ComboBox2.Text
                    If Not TextBox7.Enabled Then cb2 = ""
                    TabellaCodice.Text = TabellaCodice.Text.Replace("@@larghezza tabella@@", TextBox7.Text + cb2)
                    ...
                    TabellaCodice.Text = TabellaCodice.Text.Replace("@@vertical-align@@", TextBox17.Text)
                    ...
                    TabellaCodice.Text = TabellaCodice.Text.Replace("@@separa@@", TextBox25.Text)
                    TabellaCodice.Text = TabellaCodice.Text.Replace("@@celle vuote@@", TextBox20.Text)
                    ...
                    MyCEF.DaIncollare.Text = vbNewLine & Me.TabellaCodice.Text & vbNewLine
                ...
                Else
                    ...
                    Dim cb1 As String = ComboBox1.Text
                    If Not TextBox16.Enabled Then cb1 = ""
                    TabellaCodiceCSS.Text = TabellaCodiceCSS.Text.Replace("@@altezza tabella@@", TextBox16.Text + cb1)
                    Dim cb2 As String = ComboBox2.Text
                    If Not TextBox7.Enabled Then cb2 = ""
                    TabellaCodiceCSS.Text = TabellaCodiceCSS.Text.Replace("@@larghezza tabella@@", TextBox7.Text + cb2)
                    ...
                    TabellaCodiceCSS.Text = TabellaCodiceCSS.Text.Replace("@@vertical-align@@", TextBox17.Text)
                    ...
                    TabellaCodiceCSS.Text = TabellaCodiceCSS.Text.Replace("@@separa@@", TextBox25.Text)
                    TabellaCodiceCSS.Text = TabellaCodiceCSS.Text.Replace("@@celle vuote@@", TextBox20.Text)
                    MyCEF.buttproghtml.BackColor = Color.Red
                    MyCEF.buttprogcss.BackColor = Color.DarkRed
                    MyCEF.AnteprimaWB.Visible = False
                    MyCEF.ProgettazioneButtonR.BackColor = Color.DarkRed
                    ...
                    MyCEF.FastColoredTextBox1.Visible = True
                    MyCEF.DagliAppunti.Paste()
                    MyCEF.DaIncollare.Text = vbNewLine & Me.TabellaCodiceHTML.Text & vbNewLine
                    MyCEF.DaIncollare.SelectAll()
                    MyCEF.DaIncollare.Copy()
                    MyCEF.FastColoredTextBox1.Paste()
                    MyCEF.DaIncollare.Text = ""
                    ...
                    MyCEF.DagliAppunti.Copy()
                    MyCEF.FastColoredTextBox1.Select()
                    MyCEF.CSSFTB.Text = (MyCEF.CSSFTB.Text & TabellaCodiceCSS.Text)
                    Me.Close()
                End If
            End If
        End If
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        Colori.HEXTextBox.Text = TabellaSfondoColore.Text.Replace("#", "")
    ...
    Private Sub Button54_Click(sender As Object, e As EventArgs) Handles Button54.Click
        ...
        Colori.HEXTextBox.Text = TabellaBordiColore.Text.Replace("#", "")
        Colori.TextBox1.Text = Colori.InvertiHEX(Colori.HEXTextBox.Text)
        Colori.AnteprimaColore.BackColor = System.Drawing.ColorTranslator.FromOle("&h" & Colori.TextBox1.Text)
    ...
    Private Sub Button55_Click(sender As Object, e As EventArgs) Handles Button55.Click
        ...
        Colori.HEXTextBox.Text = TabellaTestoColore.Text.Replace("#", "")
        Colori.TextBox1.Text = Colori.InvertiHEX(Colori.HEXTextBox.Text)
        Colori.AnteprimaColore.BackColor = System.Drawing.ColorTranslator.FromOle("&h" & Colori.TextBox1.Text)
    ...
    Private Sub TextBox8_KeyPress1(sender As Object, e As KeyPressEventArgs) Handles TextBox8.KeyPress
        If (Not IsNumeric(e.KeyChar)) And (Asc(e.KeyChar) <> 8) Then
            e.Handled = True
        End If
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Process.Start("http://minionone.altervista.org/Wiki/TutteLeFunzioni/Tabella/")
    End Sub

    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox1.CheckedChanged
        If CheckBox1.CheckState = CheckState.Unchecked Then
            TextBox25.Text = ("collapse")
            CheckBox2.Enabled = False
            CheckBox2.Checked = False
        Else
            TextBox25.Text = ("separate")
    ...
    Private Sub ContextMenuStrip15_Opening(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles ContextMenuStrip15.Opening
