Public Class ControlloAggiornamenti
    ...
    Private Sub Button30_Click(sender As Object, e As EventArgs) Handles Button30.Click
        System.Diagnostics.Process.Start("http://www.mixim.altervista.org/SoftwareForWindows/MinionOne/Install.exe") 'link della nuova versione del software (la versione aggiornata) .exe
    End Sub
