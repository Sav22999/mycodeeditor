...
Public Class ControlloAggiornamenti
    ...
    Private Sub downloader_DownloadFileCompleted(sender As Object, e As System.ComponentModel.AsyncCompletedEventArgs) Handles downloader.DownloadFileCompleted
        ...
        Messaggio.testo.Text = ("La nuova versione di Minion One è stata scaricata correttamente." & Environment.NewLine & "Versione scaricata: " & WebBrowser1.DocumentText & Environment.NewLine & "Troverete il file sul Desktop")
        Me.Close()
    End Sub
