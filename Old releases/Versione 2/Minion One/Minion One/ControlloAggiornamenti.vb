...
Public Class ControlloAggiornamenti
    Public Sub CheckForUpdates()
        ...
        Dim request As System.Net.HttpWebRequest = System.Net.HttpWebRequest.Create("http://www.mixim.altervista.org/SoftwareForWindows/MinionOne/version.txt") 'link del file versione (il fle txt della versione) .txt
        ...
        If newestversion.Contains(currentversion) Then
            ...
            Messaggio.Close()
            Messaggio.Show()
            Messaggio.testo.Text = ("Stai usando già l'ultima versione di Minion One.")
    ...
    Private Sub Button30_Click(sender As Object, e As EventArgs) Handles Button30.Click
        ...
        downloader.DownloadFileAsync(New Uri("http://mixim.altervista.org/SoftwareForWindows/MinionOne/Install.exe"), Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) & "\MinionOneInstall.exe")
        Timer3.Stop()
        Timer1.Start()
    ...
    Private Sub downloader_DownloadFileCompleted(sender As Object, e As System.ComponentModel.AsyncCompletedEventArgs) Handles downloader.DownloadFileCompleted
        ...
        Messaggio.Button1.Text = ("Minion One - Download della versione completata.")
        Messaggio.Text = ("     Download della versione completata.")
        Messaggio.testo.Text = ("La nuova versione di Minion One è stata scaricata correttamente" & Environment.NewLine & "[versione " & WebBrowser1.DocumentText & "]")
        Me.Close()
    End Sub
