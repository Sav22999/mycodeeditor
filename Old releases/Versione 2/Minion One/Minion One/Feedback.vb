    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        If My.Computer.Network.IsAvailable Then
            ...
            Else
                ...
                WebBrowser1.Navigate("http://mixim.altervista.org/feedback/invio-feedback.php?oggetto=" & motivoinvio.Text & "&email=" & emailinvio.Text & "&messaggio=" & segndettinvio.Text & "&submit=Invia")
