Public Class ContrattoDiUtilizzo
    ...
    Private Sub ContrattoDiUtilizzo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = ("Stiamo scaricando il contenuto..." & Environment.NewLine & "Attendi, per favore.")
        Button8.Select()
    ...
    Private Sub WebBrowser1_DocumentCompleted(sender As Object, e As WebBrowserDocumentCompletedEventArgs) Handles WebBrowser1.DocumentCompleted
        ...
        TextBox1.Text = TextBox1.Text.Replace("&#232;", "è")
        TextBox1.Text = TextBox1.Text.Replace("&#224;", "à")
        TextBox1.Text = TextBox1.Text.Replace("&#242;", "ò")
        TextBox1.Text = TextBox1.Text.Replace("&#249;", "ù")
        TextBox1.Text = TextBox1.Text.Replace("&#236;", "ì")
        TextBox1.Text = TextBox1.Text.Replace(">", "▶")
        If TextBox1.Text.Contains("CONDIZIONI DI UTILIZZO DI MINION ONE") Then
        Else
            TextBox1.Text = ("Errore di connessione")
        End If
    End Sub

    Private Sub WebBrowser1_Navigating(sender As Object, e As WebBrowserNavigatingEventArgs) Handles WebBrowser1.Navigating
        TextBox1.Text = ("Un attimo")
    End Sub
