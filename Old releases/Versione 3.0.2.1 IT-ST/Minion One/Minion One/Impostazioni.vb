Public Class Impostazioni
    ...
    Private Sub ButtonLuminoso_Click(sender As Object, e As EventArgs) Handles ButtonLuminoso.Click
        ButtonLuminoso.BackColor = Color.Red
        ButtonChiaro.BackColor = Color.DarkRed
        ButtonScuro.BackColor = Color.DarkRed
        ButtonGiallastro.BackColor = Color.DarkRed
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("¤ü«Ä", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("Ûáà♣", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("♫♥gòó", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "0Ìü☼Ë") 'inserire nelle virgolette il codice da inserire
    End Sub

    Private Sub ButtonChiaro_Click(sender As Object, e As EventArgs) Handles ButtonChiaro.Click
        ButtonLuminoso.BackColor = Color.DarkRed
        ButtonChiaro.BackColor = Color.Red
        ButtonScuro.BackColor = Color.DarkRed
        ButtonGiallastro.BackColor = Color.DarkRed
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("¤ü«Ä", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("♫♥gòó", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("0Ìü☼Ë", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "Ûáà♣") 'inserire nelle virgolette il codice da inserire
    End Sub

    Private Sub ButtonScuro_Click(sender As Object, e As EventArgs) Handles ButtonScuro.Click
        ButtonLuminoso.BackColor = Color.DarkRed
        ButtonChiaro.BackColor = Color.DarkRed
        ButtonScuro.BackColor = Color.Red
        ButtonGiallastro.BackColor = Color.DarkRed
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("0Ìü☼Ë", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "¤ü«Ä") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Impostazioni_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf My.Settings.barrastrumentiapri = ("click") Then
        ...
        ElseIf My.Settings.tema = ("giallastro") Then
            ...
            ButtonChiaro.BackColor = Color.DarkRed
            ButtonScuro.BackColor = Color.DarkRed
            ButtonGiallastro.BackColor = Color.Red
        End If
    ...
    Private Sub Button19_Click(sender As Object, e As EventArgs) Handles Button19.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("&#&!£", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("%/<\", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("??#?!", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("%?#%%!", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("%%?%!", "") 'inserire nelle prime virgolette il codice da sostituire
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("%$£(=", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("%=)^'", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("|\ì^☸", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace(";-!_^", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("<!><_!;", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace(":*+-ò", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("ù[è[+*", "") 'inserire nelle prime virgolette il codice da sostituire
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("ò@#.,{", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button12.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("ò@#.,{", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "|\ì^☸") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button13_Click(sender As Object, e As EventArgs) Handles Button13.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("ò@#.,{", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & ";-!_^") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs) Handles Button15.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("ò@#.,{", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & ":*+-ò") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button16.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("ò@#.,{", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "ù[è[+*") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button22_Click(sender As Object, e As EventArgs) Handles Button22.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("°§ç@è}", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "{*/+*") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button21_Click(sender As Object, e As EventArgs) Handles Button21.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("{*/+*", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "°§ç@è}") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button23_Click(sender As Object, e As EventArgs) Handles ButtonGiallastro.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("0Ìü☼Ë", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "♫♥gòó") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button24_Click(sender As Object, e As EventArgs) Handles Button24.Click
        ...
        My.Settings.Save()
        If MinionOne.AnteprimaProgetto.Visible = True Then
            WebBrowser.Show()
        End If
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("é###", "")
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "?à<<")
    End Sub
    ...
    Private Sub Button23_Click_1(sender As Object, e As EventArgs) Handles Button23.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("?à<<", "")
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "é###")
    End Sub
    ...
    Private Sub Button27_Click(sender As Object, e As EventArgs) Handles Button27.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("%!?#", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "%&&#à") 'inserire nelle virgolette il codice da inserire
    End Sub
    ...
    Private Sub Button26_Click(sender As Object, e As EventArgs) Handles Button26.Click
        ...
        MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("%&&#à", "") 'inserire nelle prime virgolette il codice da sostituire
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "%!?#") 'inserire nelle virgolette il codice da inserire
    End Sub
