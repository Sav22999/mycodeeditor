Imports System.Net
Public Class InstallaNuovaVersione

    Private Sub InstallaNuovaVersione_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Button30.Select()
    ...
    Private Sub Button30_Click(sender As Object, e As EventArgs) Handles Button30.Click
        Dim Prc As New ProcessStartInfo(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) & "\MinionOneInstall.exe")
        Process.Start(Prc)
        End
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If My.Computer.Network.IsAvailable Then
            Messaggio.Close()
            Messaggio.Show()
            Messaggio.Button1.Text = ("     Dettagli versione scaricata")
            Messaggio.Text = ("Minion One - Dettagli versione scaricata")
            Messaggio.testo.Text = ("Versione scaricata: " & WebBrowser2.DocumentText & Environment.NewLine & "La versione è stata pubblicata il: " & WebBrowser1.DocumentText & Environment.NewLine & "Lingua: IT - Italiano")
        Else
        End If
    End Sub
End Class