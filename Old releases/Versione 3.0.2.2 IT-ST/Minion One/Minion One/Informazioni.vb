Public Class Info
    ...
    Private Sub Info_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Label9.ForeColor = Button1.ForeColor
        Label12.BackColor = Button1.BackColor
        Label12.ForeColor = Button1.ForeColor
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Else
            ...
            Messaggio.Close()
            Messaggio.Show()
            Messaggio.Button1.Text = ("     Rete non disponibile")
            Messaggio.Text = ("Minion One - Errore: Rete non disponibile")
            Messaggio.Button30.Text = ("Non è possibile stabilire una connessione con i nostri server." & Environment.NewLine & "Per favore, connettiti ad internet.")
        End If
    End Sub

    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        If My.Computer.Network.IsAvailable Then
            ContrattoDiUtilizzo.Show()
        Else
            Messaggio.Close()
            Messaggio.Show()
            Messaggio.Close()
