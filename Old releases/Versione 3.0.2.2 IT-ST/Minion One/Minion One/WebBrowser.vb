Public Class WebBrowser
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If My.Settings.webbrowserfinestranormaletopmost = ("si") Then
            ...
            MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("♥ìË", "")
            System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
            System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "é¤»èì")
        Else
            Me.TopMost = True
            ...
            MinionOne.salvaimpostazionitext.Text = MinionOne.salvaimpostazionitext.Text.Replace("é¤»èì", "")
            System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text)
            System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\impostazioni.imo", MinionOne.salvaimpostazionitext.Text & "♥ìË")
        End If
    End Sub
