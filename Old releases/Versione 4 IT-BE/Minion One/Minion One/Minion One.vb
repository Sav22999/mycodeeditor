...
inizioimpostazioni:
        Try
            If Dir(My.Application.Info.DirectoryPath & "\Impostazioni.moix") <> "" Then
                ImpostazioniTxt.Text = (System.IO.File.ReadAllText(My.Application.Info.DirectoryPath & "\Impostazioni.moix"))
            ...
            Else
                ...
                System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Impostazioni.moix", ImpostazioniTxt.Text)
            End If
        ...
        Try
            ...
            If argomenti.Length > 0 Then
                ...
                If filenonsupportato = False Then
                    ...
                    System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Recente6.morec", Avvio.recente5butt.Text)
                    ...
                    System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Recente5.morec", Avvio.recente4butt.Text)
                    ...
                    System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Recente4.morec", Avvio.recente3butt.Text)
                    ...
                    System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Recente3.morec", Avvio.recente2butt.Text)
                    ...
                    System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Recente2.morec", Avvio.recente1butt.Text)
                    ...
                    System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Recente1.morec", TitoloProg.Text)
                    System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\RecenteC1.morec", Button4.Text)
                    Avvio.Close()
                End If
    ...
    Private Sub Button11_Click(sender As Object, e As EventArgs) Handles AnteprimaButtonR.Click
        ...
        ElseIf Impostazioni.AvanzateTxt0.Text = ("WBP") Then
            ...
            Process.Start("file:\\\" & Button4.Text)
        Else
            If buttprogcss.Visible = True Then
                If Button4.Text.Contains(".css") Then
                    System.IO.File.WriteAllText(Button4.Text, CSSFTB.Text)
    ...
    Private Sub Button15_Click(sender As Object, e As EventArgs)
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\Recente1.morec", Me.Text.Replace(" - Minion One", ""))
        System.IO.File.WriteAllText(My.Application.Info.DirectoryPath & "\RecenteC1.morec", FastColoredTextBox1.Text)
    End Sub
