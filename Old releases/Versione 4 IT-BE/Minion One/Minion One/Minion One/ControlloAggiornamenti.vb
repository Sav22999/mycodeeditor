...
Public Class ControlloAggiornamenti
    ...
    Private Sub ScaricaButton_Click(sender As Object, e As EventArgs) Handles ScaricaButton.Click
        ...
        downloader.DownloadFileAsync(New Uri("http://minionone.altervista.org/Windows/ITA-IT/x86/Setup.exe"), (Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Aggiornamenti\Minion One Setup.!moexe"))
        Timer1.Start()
        ScaricaButton.Enabled = False
        ScaricaDopoButton.Enabled = False
