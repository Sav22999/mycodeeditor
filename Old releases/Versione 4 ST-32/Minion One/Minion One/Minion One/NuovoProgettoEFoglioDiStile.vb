            ...
            Else
                If My.Computer.FileSystem.DirectoryExists(TextBox1.Text) Then
                    If Dir(TextBox1.Text & TextBox9.Text & ".html") = "" And Dir(TextBox1.Text & TextBox9.Text & ".css") = "" Then
                        ...
                        MinionOneF.FastColoredTextBox1.Text = ("<html>" & vbNewLine & "<head>" & vbNewLine & vbTab & "<link rel=" & Chr(34) & "stylesheet" & Chr(34) & "type=" & Chr(34) & "text/css" & Chr(34) & "media=" & Chr(34) & "all" & Chr(34) & " href=" & Chr(34) & "file:\\\" & (TextBox1.Text & TextBox9.Text & ".css") & Chr(34) & " />" & vbNewLine & "</head>" & vbNewLine & "<body>" & vbNewLine & vbNewLine & vbTab & vbNewLine & "</body>" & vbNewLine & "</html>")
