    ...
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        ...
        Do While Colonna <= TextBox1.Text
            ...
            Do While Riga <= TextBox8.Text
                TextBox2.Text = TextBox2.Text & vbTab & ("<td id=" & Chr(34) & TextBox9.Text & Chr(34) & ">") & "<!---" & Riga & "° riga - " & Colonna & "° colonna--->" & vbNewLine & vbTab & "&nbsp;" & vbNewLine & vbTab & ("</td>") & vbNewLine
        ...
        Else
            If TextBox24.Text = ("si") Then
                If MinionOneF.CSSSIoNOtb.Text = ("no") Then
                    ...
                    TabellaCodice.Text = TabellaCodice.Text.Replace("@@altezza tabella@@", TextBox16.Text + ComboBox1.Text)
                    TabellaCodice.Text = TabellaCodice.Text.Replace("@@larghezza tabella@@", TextBox7.Text + ComboBox2.Text)
                ...
                Else
                    ...
                    TabellaCodiceCSS.Text = TabellaCodiceCSS.Text.Replace("@@altezza tabella@@", TextBox16.Text + ComboBox1.Text)
                    TabellaCodiceCSS.Text = TabellaCodiceCSS.Text.Replace("@@larghezza tabella@@", TextBox7.Text + ComboBox2.Text)
