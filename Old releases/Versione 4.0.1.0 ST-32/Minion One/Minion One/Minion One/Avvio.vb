Public Class Avvio
    ...
    Private Sub recente2butt_Click(sender As Object, e As EventArgs) Handles recente2butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecentC2.morec")) <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
    ...
    Private Sub recente3butt_Click(sender As Object, e As EventArgs) Handles recente3butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecentC3.morec")) <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
    ...
    Private Sub recente4butt_Click(sender As Object, e As EventArgs) Handles recente4butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecentC4.morec")) <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
    ...
    Private Sub recente5butt_Click(sender As Object, e As EventArgs) Handles recente5butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecentC5.morec")) <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
    ...
    Private Sub recente6butt_Click(sender As Object, e As EventArgs) Handles recente6butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecentC6.morec")) <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
