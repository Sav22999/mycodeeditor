Public Class Impostazioni
    ...
    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles GeneraleCheck1.CheckedChanged
        ...
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Impostazioni.moix") <> "" Then
            ...
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Impostazioni.moix", MinionOneF.ImpostazioniTxt.Text)
        Else
    ...
    Private Sub AggCheck_CheckedChanged(sender As Object, e As EventArgs) Handles GeneraleCheck0.CheckedChanged
        ...
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Impostazioni.moix") <> "" Then
            ...
            linee(19) = MinionOneF.ImpostazioniTxt.Lines(19)
            linee(20) = MinionOneF.ImpostazioniTxt.Lines(20)
            linee(21) = MinionOneF.ImpostazioniTxt.Lines(21)
    ...
    Private Sub AvanzatePercorsoRadio0_Click(sender As Object, e As EventArgs) Handles AvanzatePercorsoRadio0.Click
        ...
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Impostazioni.moix") <> "" Then
            ...
            linee(18) = MinionOneF.ImpostazioniTxt.Lines(18)
            linee(19) = MinionOneF.ImpostazioniTxt.Lines(19)
            linee(20) = MinionOneF.ImpostazioniTxt.Lines(19)
