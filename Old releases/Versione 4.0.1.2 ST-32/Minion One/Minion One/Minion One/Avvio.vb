Public Class Avvio
    ...
    Private Sub recente1butt_Click(sender As Object, e As EventArgs) Handles recente1butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC1.morec") <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
    ...
    Private Sub recente2butt_Click(sender As Object, e As EventArgs) Handles recente2butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC2.morec") <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
            ...
            End If
            MinionOneF.Button4.Text = (Percorso.Text)
            recente7butt.Text = (recente1butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente7.morec", recente1butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC7.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC1.morec"))
            recente1butt.Text = (recente2butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente1.morec", recente2butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC1.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC2.morec"))
            recente2butt.Text = (recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente2.morec", recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC2.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC7.morec"))
            Me.Close()
        Else
            MessaggioF.Text = ("Errore: File non trovato.")
            MessaggioF.Button1.Text = ("Attenzione:" & vbNewLine & "Il file non è stato trovato." & vbNewLine & "Potrebbe essere stato spostato o eliminato." & vbNewLine & "Codice errore: MOE2GBW85N6")
    ...
    Private Sub recente3butt_Click(sender As Object, e As EventArgs) Handles recente3butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC3.morec") <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
            ...
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente2.morec", recente3butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC2.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC3.morec"))
            recente3butt.Text = (recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente3.morec", recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC3.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC7.morec"))
            Me.Close()
        Else
            MessaggioF.Text = ("Errore: File non trovato.")
            MessaggioF.Button1.Text = ("Attenzione:" & vbNewLine & "Il file non è stato trovato." & vbNewLine & "Potrebbe essere stato spostato o eliminato." & vbNewLine & "Codice errore: MOE2GBW85N6")
    ...
    Private Sub recente4butt_Click(sender As Object, e As EventArgs) Handles recente4butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC4.morec") <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
            ...
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente3.morec", recente4butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC3.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC4.morec"))
            recente4butt.Text = (recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente4.morec", recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC4.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC7.morec"))
            Me.Close()
        Else
            MessaggioF.Text = ("Errore: File non trovato.")
            MessaggioF.Button1.Text = ("Attenzione:" & vbNewLine & "Il file non è stato trovato." & vbNewLine & "Potrebbe essere stato spostato o eliminato." & vbNewLine & "Codice errore: MOE2GBW85N6")
    ...
    Private Sub recente5butt_Click(sender As Object, e As EventArgs) Handles recente5butt.Click
        ...
        MinionOneF.CSSSIoNOtb.Text = ("no")
        MinionOneF.Button12.Enabled = False
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC5.morec") <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
            ...
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente4.morec", recente5butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC4.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC5.morec"))
            recente5butt.Text = (recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente5.morec", recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC5.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC7.morec"))
            Me.Close()
        Else
            MessaggioF.Text = ("Errore: File non trovato.")
            MessaggioF.Button1.Text = ("Attenzione:" & vbNewLine & "Il file non è stato trovato." & vbNewLine & "Potrebbe essere stato spostato o eliminato." & vbNewLine & "Codice errore: MOE2GBW85N6")
    ...
    Private Sub recente6butt_Click(sender As Object, e As EventArgs) Handles recente6butt.Click
        ...
        If Dir(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC5.morec") <> "" And My.Computer.FileSystem.DirectoryExists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\") Then
            ...
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente5.morec", recente6butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC5.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC6.morec"))
            recente6butt.Text = (recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\Recente6.morec", recente7butt.Text)
            System.IO.File.WriteAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC6.morec", System.IO.File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\Minion One\Temp\RecenteC7.morec"))
            Me.Close()
        Else
            MessaggioF.Text = ("Errore: File non trovato.")
            MessaggioF.Button1.Text = ("Attenzione:" & vbNewLine & "Il file non è stato trovato." & vbNewLine & "Potrebbe essere stato spostato o eliminato." & vbNewLine & "Codice errore: MOE2GBW85N6")
