Public Class Titolo
    ...
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        ...
        Else
            TextBox24.Text = ("si")
        End If
        If TitoloColoreTesto.Text = "" Then
            Button43.BackColor = Color.Red
            TextBox24.Text = ("no")
        Else
            TextBox24.Text = ("si")
        End If
        If TitoloTestoCarattere.Text = "" Then
        ...
        Else
            If TextBox24.Text = ("si") Then
                If MinionOneF.CSSSIoNOtb.Text = ("no") Then
                    ...
                    BottoneCodice.Text = BottoneCodice.Text.Replace("@@colore testo@@", TitoloColoreTesto.Text)
                    BottoneCodice.Text = BottoneCodice.Text.Replace("@@font-family@@", TitoloTestoCarattere.Text)
                ...
                Else
                    ...
                    BottoneCodiceCSS.Text = BottoneCodiceCSS.Text.Replace("@@colore testo@@", TitoloColoreTesto.Text)
                    BottoneCodiceCSS.Text = BottoneCodiceCSS.Text.Replace("@@font-family@@", TitoloTestoCarattere.Text)
    ...
    Private Sub Button55_Click(sender As Object, e As EventArgs) Handles Button55.Click
        Colori.Dove.Text = ("TestoColoreTitolo")


        Colori.HEXTextBox.Text = TitoloColoreTesto.Text.Replace("#", "")
    ...
    Private Sub Button47_Click(sender As Object, e As EventArgs) Handles Button47.Click
        Carattere.Dove.Text = ("TitoloTesto")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Process.Start("http://minionone.altervista.org/Wiki/TutteLeFunzioni/Titolo/")
    End Sub
End Class